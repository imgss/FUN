...
<article>
<header>
	<h1>郭帅 <span>imgss</span></h1>
	<ul>
		<li><a href="https://imgss.github.io">个人博客</a></li>
		<li><a href="http://cnblogs/imgss">博客园</a></li>
		<li><a href="https://github.com/imgss">Github</a></li>
	</ul>
</header>

<section id="summary">
	<h1>Summary</h1>
	<p>我是一个半路出家的前端，之前从事高(ku)大(bi)上的造船业。工作中发现自己喜欢的其实是代码，于是去年6月份(2016)开始从《dive into html》和 hello world 开始看起，大概有半年时间，处于一种痛苦，焦虑，快乐交织在一起的状态。现在在一家创业公司做前端。
	</p>
</section>
